...
<body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link disabled" href="#">Nos Equipes</a>
              </li>
              <li class="nav-item">
                <a class="nav-link disabled" href="#">Notre Association</a>
              </li>
              <li class="nav-item">
    ...
    <main class="container mt-4 p-4">
        <h1>Bienvenue chez Les <span class="navbar-brand">Lapins Celtes</span></h1>
        <blockquote class="blockquote">
            <p class="fw-lighter">Nous sommes en train de fabriquer notre nouveau site internet.</p>
        </blockquote>
    </main>
    ...
    <footer class="navbar navbar-expand-lg bg-body-tertiary fixed-bottom border-top">
        <div class="container">
            <span class="fw-light d-none d-md-block d-lg-block d-xl-block d-xxl-block" href="#">
                Copyright 2024 - Réalisé avec <i class="bi bi-arrow-through-heart-fill"></i> par Anthony Morisset
            </span>
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <span class="nav-link">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span class="d-lg-none d-xl-block d-xl-none d-xxl-block d-xxl-none">GitHub</span>
                    </a>
                </li>
            </ul>
        </div>
